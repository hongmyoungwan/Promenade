...
public class CMYKConverter {
    ...
    public BufferedImage readImage(URL imageUrl) throws IOException, ImageReadException {
        ...
        while (iter.hasNext()) {
            ...
            try {
                ...
                checkAdobeMarker(imageData);
                profile = Sanselan.getICCProfile(imageData);
    ...
    public static BufferedImage convertCmykToRgb(Raster cmykRaster, ICC_Profile cmykProfile) throws IOException {
        ...
        if (cmykProfile == null){
            cmykProfile = ICC_Profile.getInstance(CMYKConverter.class.getResourceAsStream("ISOcoated_v2_300_eci.icc"));
        }
